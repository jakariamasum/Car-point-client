...
const AdminAllProducts = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex w-full justify-center items-center">
          <p className="font-semibold text-[#0f0f0f] capitalize rounded-md text-center">
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex max-w-fit justify-center items-center">
          <img
            src={row.row.original.sellerPhoto}
            alt="product image"
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex w-full justify-center items-center">
          <p className="font-semibold text-xl text-[#000000] capitalize rounded-md text-center">
            {row.row.original.totalBids || "-"}
          </p>
        </div>
      ),
    },
    {
      ...
      cell: (row) => (
        <div className="flex w-full justify-center items-center">
          <p className="text-[18px] font-semibold text-[#ff4141] capitalize px-2 py-1 rounded-md bg-[#dddddd] text-center">
            {row.row.original.sellStatus}
          </p>
        </div>
      ),
    },
