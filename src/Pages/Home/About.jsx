  ...
  return (
    <div className="mt-[3rem] lg:mt-[5rem] flex justify-center items-center">
      <div className="container mx-auto p-5 lg:py-[3rem] flex flex-col justify-center items-center gap-5">
        ...
        <p className="md:w-2/3 text-center font-normal text-base text-lightBlack">
          We offer you a platform where you can buy and sell your car. A easy,
          reliable platform for you.
        </p>
        ...
        <div className="container mx-auto gap-14 flex flex-col md:flex-row justify-center md:justify-around items-start w-full lg:w-[90%] mt-8">
          ...
          <div className="flex flex-col gap-3 justify-center items-start">
            ...
            <p className="text-lightBlack">
              Rev up your journey with our top-notch cars for sale, and drive
              away with the best deal today. Ready to upgrade? Sell your car
              hassle-free and get top value with our seamless selling process.
            </p>
          </div>
          {/* card 2 */}
          <div className="flex flex-col gap-3 justify-center items-start">
            ...
            <p className="text-lightBlack">
              Simplicity meets efficiency with our user-friendly design, making
              it a breeze to navigate and enjoy. Experience the ease of use that
              redefines convenience in every click.
            </p>
          </div>
          {/* card 3 */}
          <div className="flex flex-col gap-3 justify-center items-start">
            ...
            <p className="text-lightBlack">
              Trust in the unwavering performance of our products, where
              reliability is not just a promise but a standard. Depend on us for
              consistency and excellence in every experience.
            </p>
          </div>
        </div>
      </div>
