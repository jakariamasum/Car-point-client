...
const UserActivity = () => {
  ...
  return (
    <div
      className="container mx-auto p-5 flex flex-col md:flex-row justify-center items-center gap-10 font-heading mt-[80px]"
      data-aos="fade-down"
    ...
    >
      <div className="bg-[#cee3ff] px-[30px] lg:px-[50px] py-[40px] lg:py-[80px] flex flex-col justify-start items-start self-stretch gap-8 rounded-lg w-full md:w-1/2">
        <h3 className="text-main text-4xl font-bold">
        ...
        <Link
          to={"/allListings"}
          className="bg-sub px-6 py-3 text-white font-medium text-xl rounded hover:bg-black duration-500 flex justify-center items-center gap-2"
        >
      ...
      <div className="bg-[#dfdfdf] px-[30px] lg:px-[50px] py-[40px] lg:py-[80px] flex flex-col justify-start items-start self-stretch gap-8 rounded-lg w-full md:w-1/2">
        ...
        <Link
          ...
          className="bg-black px-6 py-3 text-white font-medium text-xl rounded hover:bg-sub duration-500 flex justify-center items-center gap-2"
        >
