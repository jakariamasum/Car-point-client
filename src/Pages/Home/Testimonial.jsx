          ...
          <div key={singleFeedback?._id} className="text-center w-full">
            {activeFeedback === singleFeedback?._id && (
              <div className="w-full flex flex-col justify-center items-center gap-4">
                ...
                <FaQuoteLeft
                  className="text-[120px] lg:text-[150px] absolute top-[-50px] left-[-15px] md:left-[-50px] text-[#c2c2c27e]"
                  data-aos="slide-down"
                  data-aos-mirror="true"
                  data-aos-once="false"
                  data-aos-anchor-placement="top-bottom"
          ...
          <div key={singleFeedback?._id}>
            <button onClick={() => setActiveFeedback(singleFeedback?._id)}>
              <img
                ...
                alt=""
                className={`w-[65px] h-[65px] md:w-[80px] p-1 md:h-[80px] bg-cover border-4 duration-500 rounded-[50%] ${
                  activeFeedback === singleFeedback?._id
                    ? "border-sub"
                    : "border-[#ffffff00]"
                }`}
