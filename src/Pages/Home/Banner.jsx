  ...
  return (
    ...
    >
      <div className="container mx-auto px-5 pt-[70px] pb-[120px] md:pb-[350px] h-fit flex flex-col justify-start items-center font-body gap-4 relative">
        <p className="text-main text-[18px] mt-[0px] md:mt-[50px]">
          The dream place for car buy and sell
        </p>
        <h1
          className="text-black text-4xl lg:text-7xl font-bold text-center"
          data-aos="zoom-in"
          data-aos-mirror="true"
          data-aos-once="false"
          data-aos-anchor-placement="top-bottom"
        ...
        >
          ...
          <button
            type="submit"
            className="bg-sub text-white p-2 w-full md:w-fit md:p-4 lg:p-5 rounded-lg md:rounded-[100%] font-bold hover:bg-white hover:text-sub duration-500 flex justify-center items-center"
          >
