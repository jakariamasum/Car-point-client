    ...
    <div className="mt-[6rem] rounded-lg bg-lightMain flex flex-col justify-center items-center gap-4 container mx-auto px-5 py-[80px]">
      ...
      <div className="w-full md:w-[65%] lg:w-[35%] flex justify-center items-center mt-5">
        <input
          ...
          className="text-lightBlack font-medium text-[18px] px-8 py-5 w-full focus:outline-none rounded-l-[50px]"
        />
        <input
          type="submit"
          value="Sign up"
          className="text-white bg-sub text-[18px] font-semibold px-8 py-5 cursor-pointer hover:bg-black duration-500 rounded-r-[50px]"
        />
      </div>
    </div>
  );
